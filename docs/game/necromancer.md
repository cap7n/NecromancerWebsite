...
!!! success "Decided 2026-07-25: caster, no melee"
    ...
    Still open on this page: [Q5](../project/open-questions.md#q5), lone necromancer, or a clan?
...
In [co-op](../systems/multiplayer.md#shape) the natural fit is **each player is their own
necromancer with their own cult**, allied by default. Two questions follow:

- Shared or separate stockpiles? *(Proposed: separate, with trade: see [Economy](../systems/economy.md).)*
- Can lieutenant slots be filled by other players? *(Proposed: yes, opt-in, a player who wants to
  be someone's Death Knight rather than a rival lich should be able to.)*

## Progression

The player's own power is bought with **Anima** and it should be the game's rarest currency: see
[Progression](../systems/progression.md).

## Related

- [Horde Combat](combat.md) · [The Horde](horde.md) · [Multiplayer & Time](../systems/multiplayer.md)
